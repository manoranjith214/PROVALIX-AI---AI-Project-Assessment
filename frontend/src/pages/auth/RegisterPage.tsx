...
import { User, Mail, Building, Calendar, GraduationCap, Image, ArrowRight, Loader2 } from 'lucide-react';
...
export const RegisterPage: React.FC = () => {
  ...
  const validateForm = () => {
    ...
    if (!password) {
      ...
      newErrors.password = 'Password must meet all 5 security requirements';
    }
  ...
  const handleGoogleSignUp = async () => {
    ...
    try {
      ...
      setFormError(
        err?.message || 'Google sign-up could not be initiated. Please try again or use email and password.'
      );
